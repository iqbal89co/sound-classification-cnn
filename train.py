...
class ESC50Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if waveform.shape[0] > 1: # transform 2 to 1 channel
...
def train():
    ...
    train_dataset = ESC50Dataset(
        data_dir=esc50_dir, metadata_file=esc50_dir / "meta" / "esc50.csv",
    ...
    for epoch in range(num_epochs):
        ...
        print(
            f'{epoch+1} Loss: {avg_epoch_loss:.4f}, Val Loss: {avg_val_loss:.4f}, Accuracy: {accuracy:.2f}%')
